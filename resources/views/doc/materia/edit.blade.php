...
@section('content')
    ...
    <a style="float:right" href="{{ route('tareas.home') }}" class="btn btn-lg btn-success">Tareas</a>
                    ...
                    @if (count(App\User::all()) > 0)
                        @foreach (App\User::all() as $user)
                            ...
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>
                                    <a href="#" class="btn btn-xs btn-info">Actividad</a>
                                    ...
                                    <a href="#" class="btn btn-xs btn-primary">Portafolio</a>
                                </td>
